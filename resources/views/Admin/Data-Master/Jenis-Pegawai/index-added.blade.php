        ...
        <div class="container pd-x-0 mn-ht-450 mn-ht-xxl-750" id="content">
            ...
            <div>
              <nav aria-label="breadcrumb" class="mg-b-10">
                <ol class="breadcrumb breadcrumb-style2 mg-b-0">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Jenis Pegawai</li>
                </ol>
              </nav>
              <div class="d-flex align-items-center justify-content-start">
                ...
                <h4 class="tx-poppins tx-medium mg-b-0">Jenis Pegawai</h4>
              </div>
            </div>
          </div>
          {{-- <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 d-flex align-items-center justify-content-start mg-b-20 mg-sm-b-20 mg-lg-b-20">
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mg-b-20 d-flex align-items-center justify-content-start">
                <a href="#add" class="btn btn-its-3 tx-poppins tx-medium d-flex align-items-center mg-r-10" data-toggle="modal" data-animation="effect-scale"><i data-feather="plus" class="mg-r-10"></i>Tambah Data Pegawai</a>
            </div>
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mg-b-20">
              <div class="alert alert-success alert-dismissible fade show tx-roboto" role="alert">
                Jenis pegawai berhasil ditambahkan.
                      ...
                      <table id="example1" class="table table-hover table-borderless" style="width:100%">
                        <thead>
                          <tr>
                            ...
                            <th class="table-its wd-20p">Nama Jenis Pegawai</th>
                        ...
                        <tbody>
                            <tr class="bd-b">
                              ...
                              <td class="table-its">
                                <div class="d-flex align-items-center justify-content-start">
                                  <a href="" data-toggle="modal" data-target="#edit" data-animation="effect-scale"><div class="btn-circle btn btn-outline-primary mg-r-10"><ion-icon name="create" class="tx-18"></ion-icon></div></a>
