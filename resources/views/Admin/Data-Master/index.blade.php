                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 mg-b-10">
                    ...
                    <a href="{{ url('/portofolio/bahan-ajar') }}">
                        ...
                        <div class="media d-flex align-items-center justify-content-center">
                            ...
                            <p class="tx-poppins tx-medium tx-color-01 mg-b-0 tx-15 crop-text-1">Agama</p>
                            <p class="tx-13 tx-color-03 mg-b-0 crop-text-1">Data referensi agama yang ada di Indonesia.</p>
                            </div>
                        </div>
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 mg-b-10">
                    ...
                    <a href="">
                        ...
                        <div class="media d-flex align-items-center justify-content-center">
                            ...
                            <div class="media-body">
                            <p class="tx-poppins tx-medium tx-color-01 mg-b-0 tx-15 crop-text-1">Jenjang Pendidikan</p>
                            <p class="tx-13 tx-color-03 mg-b-0 crop-text-1">Data referensi jenjang pendidikan.</p>
                            </div>
                        </div>
                        <div class="btn btn-icon btn-its-custom-1 rounded-its-50p bdr-sp-50p d-flex align-items-center btn-hover"><ion-icon name="chevron-forward" class="mg-y-2 tx-18"></ion-icon></div>
                        </div>
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 mg-b-10">
                    ...
                    <a href="">
                        ...
                        <div class="media d-flex align-items-center justify-content-center">
                            ...
                            <div class="media-body">
                            <p class="tx-poppins tx-medium tx-color-01 mg-b-0 tx-15 crop-text-1">Jabatan Fungsional</p>
                            <p class="tx-13 tx-color-03 mg-b-0 crop-text-1">Data referensi jabatan fungsional.</p>
                            </div>
                        </div>
                        <div class="btn btn-icon btn-its-custom-1 rounded-its-50p bdr-sp-50p d-flex align-items-center btn-hover"><ion-icon name="chevron-forward" class="mg-y-2 tx-18"></ion-icon></div>
                        </div>
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 mg-b-10">
                    ...
                    <a href="">
                        ...
                        <div class="media d-flex align-items-center justify-content-center">
                            ...
                            <div class="media-body">
                            <p class="tx-poppins tx-medium tx-color-01 mg-b-0 tx-15 crop-text-1">Pangkat Golongan</p>
                            <p class="tx-13 tx-color-03 mg-b-0 crop-text-1">Data referensi pangkat golongan.</p>
                            </div>
                        </div>
                        <div class="btn btn-icon btn-its-custom-1 rounded-its-50p bdr-sp-50p d-flex align-items-center btn-hover"><ion-icon name="chevron-forward" class="mg-y-2 tx-18"></ion-icon></div>
                        </div>
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 mg-b-10">
                    ...
                    <a href="">
                        ...
                        <div class="media d-flex align-items-center justify-content-center">
                            ...
                            <div class="media-body">
                            <p class="tx-poppins tx-medium tx-color-01 mg-b-0 tx-15 crop-text-1">Jabatan Struktural</p>
                            <p class="tx-13 tx-color-03 mg-b-0 crop-text-1">Data referensi jabatan struktural.</p>
                            </div>
                        </div>
                        <div class="btn btn-icon btn-its-custom-1 rounded-its-50p bdr-sp-50p d-flex align-items-center btn-hover"><ion-icon name="chevron-forward" class="mg-y-2 tx-18"></ion-icon></div>
                        </div>
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 mg-b-10">
                    ...
                    <a href="{{ url('/admin/data-master/status-keaktifan') }}">
                        ...
                        <div class="media d-flex align-items-center justify-content-center">
                            <img src="{{ asset('assets/img/portfolio-ipr.svg') }}" class="wd-35 mg-r-20">
                            <div class="media-body">
                            <p class="tx-poppins tx-medium tx-color-01 mg-b-0 tx-15 crop-text-1">Status Keaktifan</p>
                            <p class="tx-13 tx-color-03 mg-b-0 crop-text-1">Data referensi status keaktifan pegawai.</p>
                            </div>
                        </div>
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 mg-b-10">
                    ...
                    <a href="{{ url('/admin/data-master/jenis-pegawai') }}">
                        ...
                        <div class="media d-flex align-items-center justify-content-center">
                            ...
                            <div class="media-body">
                            <p class="tx-poppins tx-medium tx-color-01 mg-b-0 tx-15 crop-text-1">Jenis Pegawai</p>
                            <p class="tx-13 tx-color-03 mg-b-0 crop-text-1">Data referensi jenis SDM atau pegawai.</p>
                            </div>
                        </div>
                        <div class="btn btn-icon btn-its-custom-1 rounded-its-50p bdr-sp-50p d-flex align-items-center btn-hover"><ion-icon name="chevron-forward" class="mg-y-2 tx-18"></ion-icon></div>
                        </div>
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 mg-b-10">
                    ...
                    <a href="{{ url('/portofolio/pengelola-jurnal') }}">
                        ...
                        <div class="media d-flex align-items-center justify-content-center">
                            <img src="{{ asset('assets/img/hcm-jurnal.svg') }}" class="wd-35 mg-r-20">
                            <div class="media-body">
                            <p class="tx-poppins tx-medium tx-color-01 mg-b-0 tx-15 crop-text-1">Status Kepegawaian</p>
                            <p class="tx-13 tx-color-03 mg-b-0 crop-text-1">Data referensi status kepegawaian.</p>
                            </div>
                        </div>
                        <div class="btn btn-icon btn-its-custom-1 rounded-its-50p bdr-sp-50p d-flex align-items-center btn-hover"><ion-icon name="chevron-forward" class="mg-y-2 tx-18"></ion-icon></div>
                        </div>
