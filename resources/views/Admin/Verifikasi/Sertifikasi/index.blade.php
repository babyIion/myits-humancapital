...
@section('styles')
<style>
    ul.ks-cboxtags li label span#tunggu {
        background-color: #00b8d4;
    }
    ul.ks-cboxtags li label span#setuju {
        background-color: #28a745;
    }
    ul.ks-cboxtags li label span#revisi {
...
<div class="content pd-0" style="position: relative">
          ...
          <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 d-flex align-items-center justify-content-between mg-b-20 mg-sm-b-20 mg-lg-b-20">
            <div>
              ...
              <div class="d-flex align-items-center justify-content-start">
                ...
                <h4 class="tx-poppins tx-medium mg-b-0">Sertifikasi</h4>
              </div>
            </div>
          </div>
              ...
              <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mg-b-20">
                <div class="card bd-0">
                  <div class="card-body table-responsive pd-b-10">
                    <ul class="ks-cboxtags tx-13">
                      <div class="animated shake">
                        <li class="label-info"><input type="checkbox" id="checkboxTwo" value="Cotton Candy" checked><label class="tx-color-03" for="checkboxTwo"><span id="tunggu">1</span> Menunggu verifikasi</label></li>
                        <li class="label-success"><input type="checkbox" id="checkboxThree" value="Rarity" checked><label class="tx-color-03" for="checkboxThree"><span id="setuju">1</span> Disetujui</label></li>
                        <li class="label-danger"><input type="checkbox" id="checkboxFour" value="Moondancer"><label class="tx-color-03" for="checkboxFour"><span id="revisi">0</span> Revisi</label></li>
                      </div>
                    </ul>
                    {{-- <div class="table-responsive pd-b-10"> --}}
                      <table id="example1" class="table table-hover table-borderless" style="width:100%">
                        <thead>
                          <tr>
                            <th class="table-its wd-30p">Nama SDM</th>
                            <th class="table-its wd-20p">Nama Sertifikasi</th>
                            <th class="table-its wd-10p">Jenis Sertifikasi</th>
                            <th class="table-its wd-20p">Bidang Studi</th>
                            <th class="table-its wd-20p">Nomor SK Sertifikasi</th>
                            <th class="table-its wd-10p">Tahun Sertifikasi</th>
                        ...
                        <tbody>
                            <tr class="bd-b">
                              <td class="table-its">
                                <a href="{{ url('/admin/verifikasi/sertifikasi/detail') }}" class="tx-poppins tx-medium tx-color-its3">Btari Aliya Tsabitah</a>
                              </td>
                              <td class="table-its">
                                Sertifikasi Apple
                              </td>
                              <td class="table-its">Profesional dosen</td>
                              <td class="table-its">Ilmu Komputer</td>
                              <td class="table-its">SK/ITS/V/89</td>
                              <td class="table-its">2021</td>
                              <td class="table-its">
                                <span class="badge badge-info-transparent tx-12">Menunggu verifikasi</span>
                              </td>
                            </tr>
                            <tr class="bd-b">
                              <td class="table-its">
                                <a href="{{ url('/admin/verifikasi/sertifikasi/detail') }}" class="tx-poppins tx-medium tx-color-its3">Arjuna</a>
                              </td>
                              <td class="table-its">
                                Sertifikasi Google
                              </td>
                              <td class="table-its">Profesional dosen</td>
                              <td class="table-its">Ilmu Komputer</td>
                              <td class="table-its">SK/ITS/V/99</td>
                              <td class="table-its">2021</td>
                              <td class="table-its">
                                <span class="badge badge-success-transparent tx-12">Disetujui</span>
                              </td>
                            </tr>
                        </tbody>
                      </table>
    ...
    {{-- modal tambah --}}
    <div class="modal fade effect-scale" id="add" role="dialog" aria-labelledby="add" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header bd-0 d-flex align-items-center pd-b-0">
            <h5 class="tx-poppins tx-medium mg-b-0">Tambah Jenis Pegawai</h5>
            ...
            <div class="modal-body">
              {{-- <div id="inputFormRow" class="mg-b-20 d-flex align-items-center justify-content-between"> --}}
                <div class="form-group form-floating">
                  <input name="jenis_pegawai" type="text" class="form-control @error('jenis_pegawai') is-invalid @enderror" id="jenis_pegawai" value="{{ old('jenis_pegawai') }}" placeholder="Jenis Pegawai" required>
                  <label for="jenis_pegawai">Nama Jenis Pegawai</label>
                </div>
              {{-- </div> --}}
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-its-custom-1 tx-poppins tx-medium" data-dismiss="modal">Batal</button>
              <a href="{{ url('/admin/data-master/jenis-pegawai/added') }}" class="btn btn-its-3 tx-poppins tx-medium">Tambah</a>
            </div>
          </form>
        </div>
      </div>
    ...
    {{-- modal edit --}}
    <div class="modal fade effect-scale" id="edit" role="dialog" aria-labelledby="edit" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header bd-0 d-flex align-items-center pd-b-0">
            <h5 class="tx-poppins tx-medium mg-b-0">Edit Jenis Pegawai</h5>
            <button type="button" class="btn btn-icon btn-its-custom-1 tx-poppins tx-medium rounded-its-50p d-flex align-items-center" data-dismiss="modal"><ion-icon name="close" class="mg-y-2 tx-18"></ion-icon></button>
          </div>
          <form>
            <div class="modal-body">
              {{-- <div id="inputFormRow" class="mg-b-20 d-flex align-items-center justify-content-between"> --}}
                <div class="form-group form-floating">
                  <input name="jenis_pegawai" type="text" class="form-control @error('jenis_pegawai') is-invalid @enderror" id="jenis_pegawai" value="Dosen" placeholder="Jenis Pegawai" required>
                  <label for="jenis_pegawai">Nama Jenis Pegawai</label>
                </div>
              {{-- </div> --}}
            </div>
