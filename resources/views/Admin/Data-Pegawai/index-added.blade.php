                    ...
                    {{-- <div class="table-responsive pd-b-10"> --}}
                      <table id="example1" class="table table-hover table-borderless" style="width:100%">
                        ...
                        <tbody>
                            <tr class="bd-b">
                              <td class="table-its">
                                <a href="" data-toggle="modal" data-target="#impersonate" data-animation="effect-scale" class="tx-poppins tx-medium tx-color-its3">14704141309308</a>
                              </td>
                              <td class="table-its">
                                Karna Yudha, S.Kom.
                              </td>
                            ...
                            <tr class="bd-b">
                              <td class="table-its">
                                <a href="" data-toggle="modal" data-target="#impersonate" data-animation="effect-scale" class="tx-poppins tx-medium tx-color-its3">14704141309310</a>
                              </td>
                              <td class="table-its">
                                Arjuna, S.Kom.
                              </td>
                              ...
                              <td class="table-its">Laki-laki</td>
                              <td class="table-its">S1 Teknik Informatika</td>
                              <td class="table-its"><span class="badge badge-info-transparent tx-11 mg-l-10">Ijin belajar</span></td>
                            </tr>
                        </tbody>
                      </table>
                    {{-- </div> --}}
