...
@section('title')
Monitoring Penilaian Perilaku Tendik
@endsection
                ...
                <div>
                  <nav aria-label="breadcrumb" class="mg-b-10">
                    <ol class="breadcrumb breadcrumb-style2 mg-b-0">
                      ...
                      <li class="breadcrumb-item"><a href="{{ url('/admin/qinerja/monitoring-tendik') }}">Monitoring Tendik</a></li>
                      <li class="breadcrumb-item active" aria-current="page">Perilaku</li>
                    </ol>
                  </nav>
                  <div class="d-flex align-items-center justify-content-start">
                    <div>
                      <a href="{{ url('/admin/qinerja/monitoring-tendik') }}" class="btn btn-white tx-poppins tx-medium mg-r-15"><i data-feather="arrow-left" class="wd-10 mg-r-5"></i>Kembali</a>
                    </div>
                    <h4 class="tx-poppins tx-medium mg-b-0">Monitoring Penilaian Perilaku Tendik</h4>
                  </div>
                </div>
            </div>
                  ...
                  <div class="card-body table-responsive pd-b-10">
                    <ul class="ks-cboxtags tx-13">
                      <div class="animated shake">
                        <li class="label-success"><input type="checkbox" id="checkboxThree" value="Rarity" checked><label class="tx-color-03" for="checkboxThree"><span id="setuju">1</span>Sudah menilai</label></li>
                        <li class="label-danger"><input type="checkbox" id="checkboxFour" value="Moondancer"><label class="tx-color-03" for="checkboxFour"><span id="revisi">0</span>Belum menilai</label></li>
                      </div>
                    </ul>
                    {{-- <div class="table-responsive pd-b-10"> --}}
                      <table id="example1" class="table table-hover table-borderless" style="width:100%">
                        <thead>
                          <tr>
                            <th class="table-its wd-20p">Nama Dinilai</th>
                            <th class="table-its wd-10p">Status Dinilai</th>
                            <th class="table-its wd-20p">Unit Kerja Dinilai</th>
                            <th class="table-its wd-20p">Nama Penilai</th>
                            <th class="table-its wd-10p">Status Penilai</th>
                            <th class="table-its wd-20p">Unit Kerja Penilai</th>
                            <th class="table-its wd-10p">Sebagai</th>
                          </tr>
                        </thead>
                        <tbody>
                            <tr class="bd-b">
