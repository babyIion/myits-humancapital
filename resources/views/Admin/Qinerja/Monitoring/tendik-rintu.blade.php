...
@section('title')
Monitoring Penilaian Rincian Tugas Tendik
@endsection
                ...
                <div>
                  <nav aria-label="breadcrumb" class="mg-b-10">
                    <ol class="breadcrumb breadcrumb-style2 mg-b-0">
                      ...
                      <li class="breadcrumb-item active" aria-current="page">Rincian Tugas</li>
                    </ol>
                  </nav>
                  <div class="d-flex align-items-center justify-content-start">
                    ...
                    <h4 class="tx-poppins tx-medium mg-b-0">Monitoring Penilaian Rincian Tugas Tendik</h4>
                  </div>
                </div>
            </div>
