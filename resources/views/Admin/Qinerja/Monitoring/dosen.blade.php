...
@section('title')
Monitoring Penilaian Kinerja Dosen
@endsection
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 d-flex align-items-center justify-content-between mg-b-20 mg-sm-b-20 mg-lg-b-20">
                <div>
                  ...
                  <div class="d-flex align-items-center justify-content-start">
                    ...
                    <h4 class="tx-poppins tx-medium mg-b-0">Monitoring Penilaian Kinerja Dosen</h4>
                  </div>
                </div>
            </div>
                      ...
                      <table id="example1" class="table table-hover table-borderless" style="width:100%">
                        ...
                        <tbody>
                            <tr class="bd-b">
                              ...
                              <td class="table-its d-flex justify-content-between">
                                Indra Kuncoro, S.T, M.T.
                                <span class="text-success"><ion-icon name="checkmark-circle" class="mg-r-10 tx-24"></ion-icon></span>
                                </td>
                            </tr>
                            <tr class="bd-b">
                              <td class="table-its">
                              ...
                              <td class="table-its">Bagian Tata Usaha Fakultas Teknologi Elektro dan Informatika Cerdas</td>
                              <td class="table-its d-flex justify-content-between">
                                Karna Yudha, S.Kom.
                                <span class="text-success"><ion-icon name="checkmark-circle" class="mg-r-10 tx-24"></ion-icon></span>
                                </td>
