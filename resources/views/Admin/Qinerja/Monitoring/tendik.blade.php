...
@section('title')
Monitoring Penilaian Kinerja Tendik
@endsection
...
<div class="content pd-0" style="position: relative">
    ...
    <div class="content-body">
        <div class="container pd-x-0 mn-ht-450 mn-ht-xxl-750" id="content">
                ...
                <div>
                  <nav aria-label="breadcrumb" class="mg-b-10">
                    <ol class="breadcrumb breadcrumb-style2 mg-b-0">
                      ...
                      <li class="breadcrumb-item active" aria-current="page">Monitoring Dosen</li>
                    </ol>
                  </nav>
                  <div class="d-flex align-items-center justify-content-start">
                    ...
                    <h4 class="tx-poppins tx-medium mg-b-0">Monitoring Penilaian Kinerja Tendik</h4>
                  </div>
                </div>
            </div>
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
              <h5 class="tx-poppins tx-medium mg-b-10">Berdasarkan Jenis Penilaian</h5>
            </div>
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mg-b-20 d-flex align-items-center justify-content-between">
              <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 mg-b-10">
                <div class="card bd-0">
                <a href="{{ url('/admin/qinerja/monitoring-tendik-perilaku') }}">
                    ...
                    <div class="media d-flex align-items-center justify-content-center">
                        ...
                        <p class="tx-poppins tx-medium tx-color-01 mg-b-0 tx-15 crop-text-1">Perilaku</p>
                        <p class="tx-13 tx-color-03 mg-b-0 crop-text-1" title="Penilaian perilaku pegawai berdasarkan ketentuan yang berlaku.">Penilaian perilaku pegawai berdasarkan ketentuan yang berlaku.</p>
                        </div>
                    </div>
              ...
              <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 mg-b-10">
                  <div class="card bd-0">
                  <a href="{{ url('/admin/qinerja/monitoring-tendik-rintu') }}">
                      <div class="card-body card-body d-flex align-items-center justify-content-between">
                      <div class="media d-flex align-items-center justify-content-center">
                          <img src="{{ asset('assets/img/portfolio-enterpreneurship.svg') }}" class="wd-35 mg-r-20">
                          <div class="media-body">
                          <p class="tx-poppins tx-medium tx-color-01 mg-b-0 tx-15 crop-text-1">Rincian Tugas</p>
                          <p class="tx-13 tx-color-03 mg-b-0 crop-text-1" title="Penilaian tugas-tugas yang telah diberikan kepada pegawai.">Penilaian tugas-tugas yang telah diberikan kepada pegawai.</p>
                          </div>
                      </div>
                      <div class="btn btn-icon btn-its-custom-1 rounded-its-50p bdr-sp-50p d-flex align-items-center btn-hover"><ion-icon name="chevron-forward" class="mg-y-2 tx-18"></ion-icon></div>
                      </div>
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
              <h5 class="tx-poppins tx-medium mg-b-10">Semua Penilaian</h5>
            </div>
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mg-b-20 d-flex align-items-center justify-content-between">
                <a href="#" class="btn btn-its-3 tx-poppins tx-medium d-flex align-items-center mg-r-10"><ion-icon name="print" class="mg-r-10 tx-18"></ion-icon>Cetak Excel</a>
                  ...
                  <div class="card-body table-responsive pd-b-10">
                    {{-- <div class="table-responsive pd-b-10"> --}}
                      <table id="example1" class="table table-hover table-borderless" style="width:100%">
                        <thead>
                          <tr>
                            <th class="table-its wd-15p">Nama Pegawai</th>
                            <th class="table-its wd-10p">Unit Kerja</th>
                            <th class="table-its wd-15p" title="Atasan Atasan Langsung">AAL</th>
                            <th class="table-its wd-15p" title="Atasan Langsung">AL</th>
                            <th class="table-its wd-15p">Sejawat</th>
                            <th class="table-its wd-15p">Bawahan</th>
                          </tr>
                        </thead>
                        <tbody>
                            <tr class="bd-b">
                              <td class="table-its">
                                Karna Yudha, S.Kom.
                                <p class="tx-13 tx-color-03 mg-b-0">14704141309308</p>
                              </td>
                              <td class="table-its">S1 Manajemen Bisnis</td>
                              <td class="table-its">
                                <span class="badge badge-danger-transparent tx-12">Belum ada pegawai</span>
                              </td>
                              <td class="table-its justify-content-between">
                                Indra Kuncoro, S.T, M.T.
                                <div>
                                  <span class="text-success" data-toggle="tooltip" data-placement="top" title="Rincian Tugas"><ion-icon name="checkmark-circle" class="mg-r-10 tx-24"></ion-icon></span>
                                  <span class="text-secondary" data-toggle="tooltip" data-placement="top" title="Perilaku"><ion-icon name="checkmark-circle" class="mg-r-10 tx-24"></ion-icon></span>
                                </div>
                              </td>
                              <td class="table-its">
                                Surya Hadi, S.T.
                                <div>
                                  <span class="text-secondary" data-toggle="tooltip" data-placement="top" title="Rincian Tugas"><ion-icon name="checkmark-circle" class="mg-r-10 tx-24"></ion-icon></span>
                                  <span class="text-success" data-toggle="tooltip" data-placement="top" title="Perilaku"><ion-icon name="checkmark-circle" class="mg-r-10 tx-24"></ion-icon></span>
                                </div>
                              </td>
                              <td class="table-its">
                               Arjuna, S.Kom.
