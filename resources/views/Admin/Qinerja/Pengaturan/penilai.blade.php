        ...
        <div class="container pd-x-0 mn-ht-450 mn-ht-xxl-750" id="content">
            ...
            <div>
              <nav aria-label="breadcrumb" class="mg-b-10">
                <ol class="breadcrumb breadcrumb-style2 mg-b-0">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Set Penilai (Daftar Pegawai)</li>
                </ol>
              </nav>
              <div class="d-flex align-items-center justify-content-start">
                ...
                <h4 class="tx-poppins tx-medium mg-b-0">Daftar Pegawai</h4>
              </div>
            </div>
          </div>
          {{-- <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 d-flex align-items-center justify-content-start mg-b-20 mg-sm-b-20 mg-lg-b-20">
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mg-b-20 d-flex align-items-center justify-content-start">
                <a href="#btn-filter" class="btn btn-white tx-poppins tx-medium d-flex align-items-center mg-r-10" data-toggle="modal" data-animation="effect-scale"><i data-feather="filter" class="mg-r-10"></i>Filter</a>
            </div>
                  ...
                  <div class="card-body table-responsive pd-b-10">
                    {{-- <div class="table-responsive pd-b-10"> --}}
                      <table id="example1" class="table table-hover table-borderless" style="width:100%">
                        <thead>
                          <tr>
                            <th class="table-its wd-10p">NIP</th>
                            <th class="table-its wd-20p">Nama Pegawai</th>
                            <th class="table-its wd-20p">Jabatan</th>
                            <th class="table-its wd-20p">Unit Kerja</th>
                            <th class="table-its wd-20p">Jumlah Penilai</th>
                          </tr>
                        </thead>
                        <tbody>
                            <tr class="bd-b">
                              <td class="table-its">
                                <a href="{{ url('/admin/qinerja/atur-penilai/detail') }}" class="tx-poppins tx-medium tx-color-its3">14704141309308</a>
                              </td>
                              <td class="table-its">
                                <a href="{{ url('/admin/qinerja/atur-penilai/detail') }}" class="tx-poppins tx-medium tx-color-its3">Karna Yudha, S.Kom.</a>
                              </td>
                              <td class="table-its">
                                Periode OTK :2020 - Kepala Biro Sarana dan Prasarana
                              </td>
                              <td class="table-its">
                            ...
                            <tr class="bd-b">
                              <td class="table-its">
                                <a href="" class="tx-poppins tx-medium tx-color-its3">14704141309309</a>
                              </td>
                              <td class="table-its">
                                <a href="" class="tx-poppins tx-medium tx-color-its3">Arjuna, S.Kom.</a>
                              </td>
                              <td class="table-its">
                                Periode OTK :2020 - Kepala Bagian Tata Usaha Fakultas Teknologi Elektro dan Informatika Cerdas
                              </td>
                              <td class="table-its">
                                Tata Usaha Fakultas Teknologi Elektro dan Informatika Cerdas
                              </td>
                              <td class="table-its">5</td>
                            </tr>
                        </tbody>
                      </table>
                    {{-- </div> --}}
    ...
    <div class="modal fade effect-scale" id="btn-filter" tabindex="-1" role="dialog" aria-labelledby="btn-filter" aria-hidden="true">
        ...
        <div class="modal-content tabs-animated">
            <div class="modal-header bd-0 d-flex align-items-center pd-b-0">
              ...
              <button type="button" class="btn btn-icon btn-its-custom-1 rounded-its-50p bdr-sp-50p btn-hover tx-poppins tx-medium d-flex align-items-center" data-dismiss="modal"><ion-icon name="close" class="mg-y-2 tx-18"></ion-icon></button>
            </div>
            {{-- <form action="{{url('portofolio/bahan-ajar/filter')}}" method="GET">
            {{ csrf_token() }} --}}
            <div class="modal-body pd-0">
              <div id="scroll1" class="scrollbar-lg pos-relative pd-15">
