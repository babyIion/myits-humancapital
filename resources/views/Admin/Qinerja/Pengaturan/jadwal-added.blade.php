                          ...
                          <div class="pd-15 pd-sm-10 d-flex align-items-center justify-content-between">
                            <div class="media d-flex align-items-center justify-content-center">
                              ...
                              <div class="media-body">
                                ...
                                <p class="tx-18 tx-medium mg-b-0">20 Juni 2022-07 Juli 2022</p>
                              </div>
                            </div>
                            <a href="#ModalAdd" class="btn btn-white tx-poppins tx-medium d-flex align-items-center mg-r-10" data-toggle="modal" data-animation="effect-scale"><ion-icon name="create" class="mg-y-2 tx-18 mg-r-10"></ion-icon>Edit Jadwal</a>
                          </div>
                      </div>
                    </div>
                  </div>
        ...
        <div class="modal-content">
          ...
          <form>
            ...
            <div class="modal-footer">
              ...
              <a href="{{ url('/admin/atur-jadwal-added') }}" class="btn btn-its-3 tx-poppins tx-medium">Simpan</a>
            </div>
          </form>
        </div>
      </div>
