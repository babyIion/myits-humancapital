    ...
    <div class="content-body">
        <div class="container pd-x-0 mn-ht-450 mn-ht-xxl-750" id="content">
            ...
            <div>
              <nav aria-label="breadcrumb" class="mg-b-10">
                <ol class="breadcrumb breadcrumb-style2 mg-b-0">
                  ...
                  <li class="breadcrumb-item"><a href="{{ url('/admin/qinerja/atur-penilai') }}">Set Penilai (Daftar Pegawai)</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Set Penilai</li>
                </ol>
              </nav>
              <div class="d-flex align-items-center justify-content-start">
                ...
                <h4 class="tx-poppins tx-medium mg-b-0">Set Penilai Kinerja Tendik</h4>
              </div>
            </div>
          </div>
            ...
            <div class="card bd-0">
                <div class="card-body card-list">
                    <div class="card-list-item">
                        <h5 class="tx-poppins tx-medium">Informasi Pegawai</h5>
                        <div class="row row-xs">
                          <div class="col-4 col-md-2 tx-13 tx-color-03 mg-b-10"> Nama </div>
                          <div class="col-8 col-md-10 mg-b-10"> Karna Yudha, S.Kom. </div>
                          <div class="col-4 col-md-2 tx-13 tx-color-03 mg-b-10"> NIP </div>
                          <div class="col-8 col-md-10 mg-b-10"> 14704141309308 </div>
                          <div class="col-4 col-md-2 tx-13 tx-color-03 mg-b-10"> Jabatan </div>
                          <div class="col-8 col-md-10 mg-b-10"> Periode OTK :2020 - Kepala Biro Sarana dan Prasarana </div>
                          <div class="col-4 col-md-2 tx-13 tx-color-03 mg-b-10"> Unit Kerja </div>
                          <div class="col-8 col-md-10 mg-b-10"> Biro Sarana dan Prasarana </div>
                          <div class="col-4 col-md-2 tx-13 tx-color-03 mg-b-10"> Tahun </div>
                          <div class="col-8 col-md-10 mg-b-10"> 2022 </div>
                        </div>
                    </div>
                    <div class="card-list-item border-0">
                        <h5 class="tx-poppins tx-medium">Tambah Penilai</h5>
                        <ul class="nav nav-line" id="myTab" role="tablist">
                            <li class="nav-item">
                              <a class="tx-poppins nav-link active" id="manual-tab" data-toggle="tab" href="#manual" role="tab" aria-controls="manual" aria-selected="true">Set Manual</a>
                            </li>
                            <li class="nav-item">
                              <a class="tx-poppins nav-link" id="random-tab" data-toggle="tab" href="#random" role="tab" aria-controls="random" aria-selected="false">Set Random</a>
                            </li>
                            <li class="nav-item">
                              <a class="tx-poppins nav-link" id="previous-tab" data-toggle="tab" href="#previous" role="tab" aria-controls="previous" aria-selected="false">Set Seperti Periode Sebelumnya</a>
                            </li>
                        </ul>
                        <div class="tab-content pd-t-20" id="myTabContent">
                            <div class="tab-pane fade show active" id="manual" role="tabpanel" aria-labelledby="manual-tab">
                                <div class="d-flex align-items-center justify-content-start mg-b-10"><ion-icon name="information-circle" class="tx-18"></ion-icon><span class="mg-l-10">Tambah penilai dengan cara mengisi form.</span></div>
                                <form action="{{url('admin/data-pegawai/save')}}" method="POST" role="form" id="my-form">
                                    @csrf
                                    <div class="form-group form-floating">
                                        <select class="form-select select2 @error('jenis_penilai') is-invalid @enderror" name="jenis_penilai" id="jenis_penilai" required>
                                            <option label="Pilih jenis penilai"></option>
                                            <option>Atasan Langsung</option>
                                            <option>Sejawat</option>
                                            <option>Bawahan</option>
                                        </select>
                                        <label for="jenis_penilai">Jenis Penilai<span style="color:red"> *</span></label>
                                        @error('jenis_penilai')
                                    ...
                                    <div class="form-group form-floating">
                                        <select class="form-select select2 @error('nama_penilai') is-invalid @enderror" name="nama_penilai" id="nama_penilai" required>
                                            <option label="Cari Pegawai"></option>
                                            <option>Tristan Nugroho, S.Si.</option>
                                            <option>Bedi Victor, S.T.</option>
                                            <option>Genta Aji, S.T.</option>
                                        </select>
                                        <label for="nama_penilai">Nama Pegawai<span style="color:red"> *</span></label>
                                        @error('nama_penilai')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div>
                                        <button type="button" class="btn btn-its-3 tx-poppins tx-medium float-right" id="tambah">Tambah</button>
                                    </div>
                                </form>
                            </div>
                            <div class="tab-pane fade" id="random" role="tabpanel" aria-labelledby="random-tab">
                                <div class="d-flex align-items-center justify-content-start mg-b-10"><ion-icon name="information-circle" class="tx-18"></ion-icon><span class="mg-l-10">Tambah penilai dengan jenis <strong>sejawat dan bawahan</strong> secara acak oleh sistem.</span></div>
                                <button type="button" class="btn btn-white tx-poppins tx-medium" id="randomBtn">Set random</button>
                            </div>
                            <div class="tab-pane fade" id="previous" role="tabpanel" aria-labelledby="previous-tab">
                                <div class="d-flex align-items-center justify-content-start mg-b-10"><ion-icon name="information-circle" class="tx-18"></ion-icon><span class="mg-l-10">Tambah penilai secara <strong>otomatis sama</strong> seperti <strong>periode sebelumnya</strong>.</span></div>
                                <button type="button" class="btn btn-white tx-poppins tx-medium" id="previousBtn">Set seperti periode sebelum</button>
                            </div>
                        </div>
                    </div>
                </div>
          ...
          <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mg-b-20">
            <h5>Daftar Penilai dari Karna Yudha, S.Kom.</h5>
          </div>
                      ...
                      <table id="example1" class="table table-hover table-borderless" style="width:100%">
                        <thead>
                          <tr>
                            ...
                            <th class="table-its wd-20p">Jenis Penilai</th>
...
<script>
  $(function(){
      ...
      $('#nama_penilai').select2({
        placeholder: "Cari Pegawai",
        searchInputPlaceholder: 'Cari',
        allowClear: true,
        dropdownParent: $('#manual')
      });

      $('#jenis_penilai').select2({
        placeholder: "Pilih salah satu",
        searchInputPlaceholder: 'Cari',
        allowClear: true,
        dropdownParent: $('#manual')
