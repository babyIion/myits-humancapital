...
<aside class="aside aside-fixed">
    ...
    <div class="aside-body">
      <ul class="sidebar-nav">
        ...
        <li class="nav-item"><a href="profil" class="nav-link-its-active tx-poppins tx-medium text-truncate"><img src="{{ asset('assets/img/profile-blank.png') }}" class="wd-20 ht-20 mg-r-15 img-fluid rounded-circle" style="object-fit: cover;">Profil</a></li>
                ...
                <div class="card-body pos-relative">
                  <div class="pos-absolute t--60">
                    <div class="profile-pic">
                      <img src="{{ asset('assets/img/profile-blank.png') }}" class="rounded-circle" id="profileImage" width="100" />
                    </div>
                  </div>
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
              <div class="row row-xs">
                  <div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 mg-b-10">
                      <div class="card bd-0">
                          <div class="card-body">
                              <img src="{{ asset('assets/img/intern.svg') }}" class="wd-40 mg-r-20 mg-t-5 mg-b-20">
                              ...
                              <a class="btn btn-its-3 tx-poppins tx-regular" href="/profil/biodata"> Selengkapnya</a>
                          </div>
                      </div>
                  </div>
                  <div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 mg-b-10">
                      <div class="card bd-0">
                          <div class="card-body">
                              ...
                              <a class="btn btn-its-3 tx-poppins tx-regular" href="">Selengkapnya</a>
                          </div>
                      </div>
                  </div>
                  <div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 mg-b-10">
